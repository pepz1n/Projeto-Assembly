...
MAX		EQU	.255	;VALOR MÁXIMO PARA O CONTADOR
...
MAIN
	...
	GOTO	ATUALIZA	;SIM, VAI PARA ATUALIZA PARA MOSTRAR A SAÍDA DO VALOR REPRESENTADO NO CONTADOR
				;NÂO, VAI PARA TRATA_BT
TRATA_BT   
...
ATUALIZA
	...
	BTFSC	BOTAO		;O BOTÃO CONTINUA PRESSIONADO?
